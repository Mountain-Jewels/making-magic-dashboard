...
export function CreativeToolBar({ activeTool, onToolChange, disabled }: CreativeToolBarProps) {
  return (
    <TooltipProvider>
      <div className="flex-shrink-0 flex flex-wrap items-center justify-center gap-1 bg-white text-gray-900 rounded-2xl border-[3px] border-brand-gold/50 shadow-sm px-2 sm:px-3 py-2">
